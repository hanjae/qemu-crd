...
static void crd_bh_cb(void *opaque)
{
    CrdAIOCB *acb = opaque;
...
static inline BlockAIOCB *crd_aio_common(BlockDriverState *bs,
                                          ...
                                          void *opaque)
{
    ...
    acb->bh = aio_bh_new(bdrv_get_aio_context(bs), crd_bh_cb, acb);
...
static BlockAIOCB *crd_aio_readv(BlockDriverState *bs,
                                  ...
                                  void *opaque)
{
    return crd_aio_common(bs, cb, opaque);
}
